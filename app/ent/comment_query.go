...
func (_q *CommentQuery) QueryVendor() *VendorQuery {
...
func (_q *CommentQuery) WithVendor(opts ...func(*VendorQuery)) *CommentQuery {
	query := (&VendorClient{config: _q.config}).Query()
...
func (_q *CommentQuery) loadVendor(ctx context.Context, query *VendorQuery, nodes []*Comment, init func(*Comment), assign func(*Comment, *Vendor)) error {
