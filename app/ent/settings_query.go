...
func (_q *SettingsQuery) QueryMainItem() *ItemQuery {
...
func (_q *SettingsQuery) Clone() *SettingsQuery {
	...
	return &SettingsQuery{
		...
		withMainItem: _q.withMainItem.Clone(),
...
func (_q *SettingsQuery) WithMainItem(opts ...func(*ItemQuery)) *SettingsQuery {
	query := (&ItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withMainItem = query
	return _q
}
...
func (_q *SettingsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Settings, error) {
	...
	if query := _q.withMainItem; query != nil {
		if err := _q.loadMainItem(ctx, query, nodes, nil,
...
func (_q *SettingsQuery) loadMainItem(ctx context.Context, query *ItemQuery, nodes []*Settings, init func(*Settings), assign func(*Settings, *Item)) error {
