...
func (_q *LocationQuery) QueryVendor() *VendorQuery {
...
func (_q *LocationQuery) WithVendor(opts ...func(*VendorQuery)) *LocationQuery {
	query := (&VendorClient{config: _q.config}).Query()
...
func (_q *LocationQuery) loadVendor(ctx context.Context, query *VendorQuery, nodes []*Location, init func(*Location), assign func(*Location, *Vendor)) error {
