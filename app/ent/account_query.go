...
func (aq *AccountQuery) QueryVendor() *VendorQuery {
	query := (&VendorClient{config: aq.config}).Query()
...
func (aq *AccountQuery) Clone() *AccountQuery {
	...
	return &AccountQuery{
		...
		withVendor: aq.withVendor.Clone(),
...
func (aq *AccountQuery) WithVendor(opts ...func(*VendorQuery)) *AccountQuery {
	query := (&VendorClient{config: aq.config}).Query()
...
func (aq *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := aq.withVendor; query != nil {
		if err := aq.loadVendor(ctx, query, nodes, nil,
...
func (aq *AccountQuery) loadVendor(ctx context.Context, query *VendorQuery, nodes []*Account, init func(*Account), assign func(*Account, *Vendor)) error {
