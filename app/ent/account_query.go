...
func (_q *AccountQuery) QueryVendor() *VendorQuery {
...
func (_q *AccountQuery) WithVendor(opts ...func(*VendorQuery)) *AccountQuery {
	query := (&VendorClient{config: _q.config}).Query()
...
func (_q *AccountQuery) loadVendor(ctx context.Context, query *VendorQuery, nodes []*Account, init func(*Account), assign func(*Account, *Vendor)) error {
